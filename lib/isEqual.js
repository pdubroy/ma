...
// A sentinel value that matches anything. Making it a function prevents
// immutable-js from converting it to a Vector or a Map.
var ANY = function(){ return true; };
ANY.toString = function() { return '_' };
...
var eq = function(a, b, aStack, bStack) {
  ...
  // Support `ANY` and predicates, but only for the `b` object.
  if (_.isFunction(b))
    return b(a);
